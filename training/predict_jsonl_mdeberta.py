#!/usr/bin/env python3
"""
Real-time prediction script for MDeBERTa models trained on CSV data.
...
class RealTimePredictor:
    ...
    def interactive_predict(self):
        ...
        print("\n" + "="*70)
        print(" Real-time MDeBERTa Prediction for Clinical Data")
        print("="*70)
...
def main():
    """Main function."""
    parser = argparse.ArgumentParser(description='Real-time prediction with trained MDeBERTa model')
    
    parser.add_argument('--config', type=str, default='src/config/base_mdeberta.yaml',
                        help='Path to configuration file')
    parser.add_argument('--labels_path', type=str, default='data/processed/labels_6class.json',
